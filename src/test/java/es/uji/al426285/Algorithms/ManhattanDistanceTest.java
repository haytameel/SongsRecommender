...
class ManhattanDistanceTest {
    ...
    ManhattanDistance prueba1=new ManhattanDistance();
    ...
    void calculateDistance() {
        asignar_valores();
        assertEquals(6,    prueba1.calculateDistance(lista1,lista2));
        assertEquals(15,    prueba1.calculateDistance(lista3,lista4));
        lista1=lista2=null;
